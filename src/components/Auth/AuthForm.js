...
const AuthForm = () => {
 ...
 let url;
    if (isLogin) {
      url='https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBCwLo6dO4SHsWLhyvfews8HHdmpv-II7A'
    } else {
      url = 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBCwLo6dO4SHsWLhyvfews8HHdmpv-II7A'
    }
